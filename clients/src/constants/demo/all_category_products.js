// export products of a particular category

export const AllCategoryProducts = [
    {
        id: "1",
        seller_id: "1",
        total_product_images: 566,
        category: "smartphones",
        quantity: 4,
        max_quantity: 5,        // max quantity you can buy
        tagline: 'Deal of the day',
        delivery_charges: 10,
        free_delivery_over: 500,        // over Rs. 500 (null means no free delivery or the delivery_charges are already 0)
        delivery_time: 6,       // days
        total_sold: 500,
        total_questions: 12,
        total_reviews: 6,
        total_review_images: 566,
        total_ratings: 67,
        average_stars: 4.5,
        stars: {
            '5': 10,
        ...
        services: {
            ...
            'Warranty': '5 years',      // else undefined
            'Return': '5 days',
            'Replacement': '5 days',
        },
        ...
        Specifications: {
            'General': {
                ...
                'Model Number': `wrb-sw-colorfiticon2-std-blu_blu`,
